...
public class CharactersAdapter_ extends RecyclerView.Adapter<CharactersAdapter_.CharactersViewHolder> {

    private List<Character> list;

    public CharactersAdapter_(List<Character> charactersList) {
