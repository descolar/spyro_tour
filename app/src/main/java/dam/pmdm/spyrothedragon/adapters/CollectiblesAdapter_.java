...
public class CollectiblesAdapter_ extends RecyclerView.Adapter<CollectiblesAdapter_.CollectiblesViewHolder> {

    private List<Collectible> list;

    public CollectiblesAdapter_(List<Collectible> collectibleList) {
